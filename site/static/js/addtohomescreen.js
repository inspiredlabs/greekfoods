...
ath.intl = {
	de_de: {
		message: 'Um diese InstantWebapp zum Home-Bildschirm hinzuzufügen,<br>tippen Sie auf %icon und dann <strong>%action</strong>.',
		action: { ios: 'Zum Home-Bildschirm', android: 'Zum Startbildschirm hinzufügen', windows: 'Auf Startseite' }
	},

	en_us: {
		message: 'Add InstantWebapp to home screen:<br>tap %icon and then <strong>%action</strong>.',
		action: { ios: 'Add to Home Screen', android: 'Add to homescreen', windows: 'pin to start' }
	},

	es_es: {
		message: 'Para añadir esta InstantWebapp a la pantalla de inicio:<br>pulsa %icon y selecciona <strong>%action</strong>.',
		action: { ios: 'Añadir a pantalla de inicio', android: 'Añadir a pantalla de inicio', windows: 'Añadir a inicio' }
	},

	fr_fr: {
		message: 'Pour ajouter cette InstantWebapp sur l\'écran d\'accueil :<br>Appuyez %icon et sélectionnez <strong>%action</strong>.',
		action: { ios: 'Ajouter sur l\'écran d\'accueil', android: 'Ajouter à l\'écran d\'accueil', windows: 'Épingler à l\'écran d\'accueil' }
	},

	it_it: {
		message: 'Per Aggiungere questa InstantWebapp alla schermata iniziale:<br>premi %icon e poi <strong>%action</strong>.',
		action: { ios: 'Aggiungi a Home', android: 'Aggiungi alla homescreen', windows: 'aggiungi a start' }
	},

	nb_no: {
		message: 'For å installere denne InstantWebapp på hjem-skjermen:<br>trykk på %icon og deretter <strong>%action</strong>.',
		action: { ios: 'Legg til på Hjem-skjerm', android: 'Legg til på startsiden', windows: 'fest til start' }
	},

	nl_nl: {
		message: 'Om deze InstantWebapp op je telefoon te installeren,<br>klik op %icon en dan <strong>%action</strong>.',
		action: { ios: 'Voeg toe aan beginscherm', android: 'Toevoegen aan startscherm', windows: 'Aan startscherm vastmaken' }
	},

	sv_se: {
		message: 'För att lägga till denna InstantWebapp på hemskärmen:<br>tryck på %icon och därefter <strong>%action</strong>.',
...
ath.Class.prototype = {
	...
	_show: function () {
		...
		setTimeout(function () {
			...
			that.element.style.webkitTransitionDuration = '0.333s';
		}, 0);
